...
function ContactSelect({ options, placeholder, className, ...rest }: any) {
  return (
    <div className={`relative ${className ?? ""}`}>
      <select
        {...rest}
        className="h-[52px] w-full appearance-none rounded-xl border-0 bg-[#F5F6F7] px-4 pr-10 font-alt text-[16px] font-medium tracking-[0.03em] text-[#929292] transition focus:bg-white focus:outline-none focus:ring-4 focus:ring-[#5A3BFF]/20"
